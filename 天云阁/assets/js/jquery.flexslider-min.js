    ...
    e.flexslider = function(a, n) {
        ...
        g = {
            init: function() {
                ...
                "" !== i.vars.controlsContainerNav && (i.controlsContainerNav = e(i.vars.controlsContainerNav).length > 0 && e(i.vars.controlsContainerNav)),
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    var t, a,ptext, n = "thumbnails" === i.vars.controlNav ? "control-thumbs": "control-paging",
                    s = 1;
                    if (i.controlNavScaffold = e('<ol class="' + r + "control-nav " + r + n + '"></ol>'), i.pagingCount > 1) for (var o = 0; o < i.pagingCount; o++) {
                        ...
                        if(i.vars.pagesText && i.vars.pagesText[s-1]){
                            ptext = i.vars.pagesText[s-1];
                        }else{
                            ptext = s;
                        }
                        if (t = "thumbnails" === i.vars.controlNav ? '<img src="' + a.attr("data-thumb") + '"' + l + "/>": '<a href="#">' + ptext + "</a>", "thumbnails" === i.vars.controlNav && !0 === i.vars.thumbCaptions) {
                    ...
                    i.controlsContainerNav ? e(i.controlsContainerNav).append(i.controlNavScaffold) : i.append(i.controlNavScaffold),
                    g.controlNav.set(),
                    g.controlNav.active(),
                ...
                set: function() {
                    ...
                    i.controlNav = e("." + r + "control-nav li " + t, i.controlsContainerNav ? i.controlsContainerNav: i)
                },
                active: function() {
